...
public class AuditorPeriodicCheckTest extends BookKeeperClusterTestCase {
    ...
    /**
     * test that the period checker will detect the missing of index files.
     */
    @Test
    public void testIndexMissing() throws Exception {
        ...
        File index = new File(ledgerDir, IndexPersistenceMgr.getLedgerName(ledgerToMissing));
        ...
        assertEquals("Ledger should be under replicated", ledgerToMissing, underReplicatedLedger);
        underReplicationManager.close();
    }
